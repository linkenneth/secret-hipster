...
\begin{multicols}{3}
  ...
  \begin{align*}
    ...
    COP = \frac{Q_L}{W} \text{ (refridge)} = \frac{T_L}{T_H - T_L} \text{
      (Carnot)} \\
  ...
  \begin{align*}
    ...
    W = \int_{\theta_1}^{\theta_2} \tau d\theta \text{ (dipole) }; U = -W = -\vec{p} \cdot \vec{E} \\
  ...
  \textbf{25: Resistivity}
  \begin{align*}
    \bar{P} = I_{\text{rms}}V_{\text{rms}} = I_{\text{rms}}^2 R
    = \frac{V_{\text{rms}}^2}{R} \\
    j = \frac{I}{A}, I = \int \vec{j} \cdot d\vec{A},
    \vec{j} = \frac{1}{\rho} \vec{E}
  \end{align*}
  
  \textbf{27: Magnetism}
  \begin{align*}
    I \iff B, I \text{ and } B \iff F \\
    \vec{F} = I \vec{l} \times \vec{B}
    = q \vec{v} \times \vec{B} \\
    \vec{\mu} = NI \vec{A_{\text{encl}}} \text{ (magnetic dipole moment)} \\
    \vec{\tau} = \vec{\mu} \times \vec{B} = NI\vec{A} \times \vec{B} \\
    U = -\vec{\mu} \cdot \vec{B} \text{ ($U = 0$ at $\theta = \pi/2$)}
  \end{align*}
  
  \textbf{28: Sources of Magnetism}
  \begin{align*}
    \oint \vec{B} \cdot d \vec{l} = \mu_0 I_{\text{encl}}
    \text{ (Ampere's Law)} \\
    \vec{B} = \frac{\mu_0I}{4 \pi} \int \frac{d\vec{l} \times \hat{r}}{r^2}
    \text{ (Biot-Savart Law)} \\
    B = \frac{\mu_0 I}{2 \pi r} \text{ (near long straight wire)} \\
    B = \mu_0\frac{N}{l}I \text{ (solenoid)} \\
    B = \frac{\mu_0 I R^2}{2(R^2+x^2)^{3/2}} \text{ (current loop)} \\
    B = \frac{\mu_0}{2 \pi}\frac{\mu}{(R^2+x^2)^{3/2}} \text{ (magnetic
      dipole)}
  \end{align*}
